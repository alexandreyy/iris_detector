...
/**
 * @brief Converts values from [0,1] to R, G, B colors according to the rainbow color map (from blue to red). 
 ...
 * @ingroup Color
 */
  void iftRainbowColorMapping(float value,float* R,float* G,float* B);
